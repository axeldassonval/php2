...
<html lang="fr">
 ...
 <!--debut prog formulaire-->
				...
				<form action="verificationFormulaire.php" method="post"> 
					...
					<br>
					<p><input type="checkbox" name="validation" value="validation" id="traitement" > Jaccepte de vous vendre mon ames et de me faire spam de pub</p>
